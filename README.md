...
Si à la suite du test du chi-2 on conclut à un lien significatif entre les 2 varibles il est pertinent d'effectuer une regression logistique binomiale afin de mesurer l'impact d'une variable sur l'autre.
